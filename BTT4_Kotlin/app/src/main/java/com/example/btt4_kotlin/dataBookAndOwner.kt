...
var listBookAndItsOwner = mutableMapOf(
    "Mai Nguyen Dang Khoa" to listOf("Toán", "Sử", "Anh", "Lý","Sách chỉ cách giảm cân","Cách bắn phi phai hay như bác gấu","Sách dạy tiếng Phú Yên", "Cách nấu cơm gà Phú Yên"),
